        ...
        <div className="Accueil">
            ...
            <section className="description">
                ...
                <article className="article">
                    <p className="txt-article">Ne manquez aucun rendez-vous avec votre carnet disponible sur notre site ! <br/> Vous pouvez également retrouver les coordonnées de votre vétérinaire dans la rubrique "Contact".</p>
